...
+ `r round(modelA$coefficients$estimate[25], 3)`$x_{24}$
...
$x_{10}$ is `r modelA$coefficients$term[21]`   
...
* plus a percent change associated with the month of theatrical release.      
