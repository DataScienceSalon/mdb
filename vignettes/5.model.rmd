...
gridExtra::grid.arrange(gridExtra::arrangeGrob(modelA$plots$linearity[[1]],
                        ...
                        gridExtra::arrangeGrob(modelA$plots$linearity[[7]],
                                               modelA$plots$linearity[[8]], 
                                               modelA$plots$linearity[[9]], ncol = 3),
                         nrow = 3)
...
* plus `r round(subset(modelA$coefficients, term == "cast_scores", select = estimate), 3)` log IMDB votes for each composite score point earned by the cast members,
...
* plus `r round(subset(modelA$coefficients, term == "cast_experience_log", select = estimate), 3)` log IMDB votes for each log of the number of movies in which the cast has previously appeared,
* plus `r round(subset(modelA$coefficients, term == "runtime_log", select = estimate), 3)` log IMDB votes for each log minute of runtime,
...
* plus `r round(subset(modelA$coefficients, term == "cast_votes_log", select = estimate), 3)` log IMDB votes for the log of the votes previously earned by the cast members,
