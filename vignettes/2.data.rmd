...
Lastly, the data were split into a training set (80%) and a test set (20%). The following exploratory data analysis and modeling was performed on the training set.
